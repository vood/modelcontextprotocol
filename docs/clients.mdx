...
| [Writingmate.ai][Writingmate.ai]                 | ❌          | ❌        | ✅      | ✅                     | ❌         | ❌    | Supports discovery and tools     
...
Writingmate.ai is a roboust all in one AI platfrom with access to over 200+ LLM models, custom agents capabilities and MCP support. It is a web based application that currently supports tools and automatic discovery.

**Key features:**

- Prompt templates surface as slash commands in the editor
- Tool integration for creating custom agents to aid your business workflows
- Supports Auth 2.1 and discovery protocol
